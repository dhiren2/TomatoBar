...
private struct IntervalsView: View {
    ...
    var body: some View {
        VStack {
            ...
            Stepper(value: $timer.shortRestIntervalLength, in: 1 ... 1440) {
                HStack {
            ...
            Stepper(value: $timer.longRestIntervalLength, in: 1 ... 1440) {
                HStack {
            ...
            Stepper(value: $timer.workIntervalsInSet, in: 1 ... 1440) {
                HStack {
